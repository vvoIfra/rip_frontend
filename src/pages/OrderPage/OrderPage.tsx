...
const  OrderPage: FC = () => {
    ...
    const deleteFromCart = async (ship_id: number) => {
        try {
            await axios(`/api/links/delete_class_from_order/${ship_id}/`, {
                method: "DELETE",
                headers: {
                    'authorization': session_id
                }
    ...
    const addToCart = async (ship_id: number) =>  {
        try{
        await axios(`/api/classes_of_ships/${ship_id}/add_to_order/`, {
            method: "POST",
            headers: {
                'authorization': session_id
            },
    ...
    const deleteCart = async () => {
        try {
            await axios(`/api/orders/delete_order/`, {
                method: "PUT",
                headers: {
                    'authorization': session_id
                }
    ...
    const sendCart = async () => {
        try {
            await axios(`/api/orders/form_order/`, {
                method: "PUT",
                headers: {
                    'authorization': session_id
                }
